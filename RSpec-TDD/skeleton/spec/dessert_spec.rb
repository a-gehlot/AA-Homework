...
describe Dessert do
  ...
  subject(:dessert) { Dessert.new("brownie", 30, chef) }
  ...
  describe "#mix!" do
    it "shuffles the ingredient array" do
      ingredients = %w[butter flour eggs milk chocolate cocoa]
  ...
  describe "#serve" do
    it "contains the titleized version of the chef's name" do
      ...
      expect(dessert.serve).to eq("Chef Tucker the Great Baker has made 30 brownies!")
    end
  end
